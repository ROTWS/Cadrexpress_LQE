...
function goStep(n) {
  ...
  // FIX : quand on arrive sur l'écran 2, re-synchroniser toutes les valeurs
  if (n === 2) {
...
// ============================================
// Questionnaire LIVE (écran 1 - colonne droite)
// ============================================
...
// ============================================
// Questionnaire COMPLET (écran 2 - validation)
// ============================================
...
// ============================================
// FIX MAJEUR : mise à jour centralisée et fiable
// ============================================
function updateAnswer(qid, value) {
  // 1. Stocker dans le state (source de vérité)
  STATE.answers[qid] = value;

  // 2. Mettre à jour la vue LIVE (écran 1, colonne droite) — TOUJOURS
...
// ============================================
// NOUVELLE FONCTION : synchroniser toutes les réponses vers l'écran 2
// (utilisé quand on arrive sur l'écran 2 pour la première fois)
// ============================================
...
// ============================================
// Mise à jour de la vue LIVE (écran 1 droit) — FIABILISÉE
// ============================================
function updateLiveItem(qid, value) {
  ...
  if (hasValue) {
    ...
    // Pulse de l'indicateur live
    pulseLiveIndicator();

    // Auto-scroll pour montrer la mise à jour (seulement si on est sur l'écran 1)
