...
// ============================================
// Mise à jour d'une réponse (synchronise les 2 vues)
// ============================================
function updateAnswer(qid, value) {
  STATE.answers[qid] = value;

  // Écran 2 : questionnaire complet
  ...
  // Synchroniser les 2 inputs (écran 2)
  const el2 = document.querySelector(`.q-input[data-qid="${qid}"]`);
  if (el2 && el2.value !== value) el2.value = value;

  // Écran 1 : questionnaire live
...
// ============================================
// Mise à jour de la vue LIVE (écran 1 droit)
// ============================================
function updateLiveItem(qid, value) {
  ...
  if (hasValue) {
    ...
    // Auto-scroll pour montrer la mise à jour
...
document.addEventListener('DOMContentLoaded', () => {
  buildQuestionnaireLive();  // vue split écran 1
  buildQuestionnaire();       // vue complète écran 2
  setupDragDrop();
  checkApiStatus();
});
